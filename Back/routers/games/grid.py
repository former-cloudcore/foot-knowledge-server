...
async def get_all_answers(team1='', team2='', nationality='', league1='', league2='',
    ...
    return await GridService(session).all_answers(team1=team1, team2=team2, nationality=nationality, league1=league1,
                                            league2=league2)
...
async def get_is_currect(player_id: int, team1='', team2='', nationality='', league1='', league2='',
    ...
    if player_id is None:
        return False
    a = await GridService(session).all_answers(team1=team1, team2=team2, nationality=nationality, league1=league1,
                                         league2=league2)
