...
async def get_teams(
    ...
    return await TeamService(session).get_teams()
...
async def get_team(
    ...
    return await TeamService(session).get_team(team_id)
...
async def get_teams_by_league(
    ...
    return await TeamService(session).get_teams_by_league(league_id)
